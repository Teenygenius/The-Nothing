      ...
      <div className="glass-card rounded-3xl p-8 sm:p-10 shadow-2xl border border-gray-200 dark:border-void-800">
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
            Enter your credentials to access your inactivity metrics.
          </p>
        </div>

        {error && (
          <div className="mb-6 p-3.5 rounded-xl bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-900 text-rose-600 dark:text-rose-400 text-xs flex items-start gap-2 animate-in fade-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            ...
            {loading ? 'Authenticating Nothing...' : 'Sign In'}
          </button>
        </form>
